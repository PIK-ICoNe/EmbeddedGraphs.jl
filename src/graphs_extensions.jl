...
"""
    Extends Graphs function and deletes also the element in the
    EG.vertexpos array. rem_vertex! in Graphs swaps the vertex v with
...
"""Extends basic Graphs functions to work with AbstractEmbeddedGraphs"""
...
# The following is not in Graphs Interface jl
